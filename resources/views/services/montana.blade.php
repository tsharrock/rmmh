...
@section('content')
    <div class="hero montana hero-mt-6 border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1>Telehealth Services<br class="d-none d-md-block"> in Montana</h1>
                </div>
            </div>
        </div>
    </div>
    <div class="container my-5">
        <div class="row">
            <div class="col-md-8">
                ...
                <p>Tiffany Redmond, PA-C, is licensed in Montana and provides the following services to patients across the
