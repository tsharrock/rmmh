...
@section('content')
    <div class="hero iowa border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-md-4 offset-lg-1">
                    <h1>Services & Insurance in Iowa</h1>
                </div>
            </div>
        </div>
    </div>
    <div class="container my-5">
        <div class="row">
            <div class="col-md-8">
                ...
                <p>Tiffany Redmond, PA-C, is licensed in Iowa and provides the following services to patients across the state via secure telehealth. Ketamine Therapy and IV Nutrition & Injectables require in-person administration and are only available at our Hyde Park, Utah clinic.</p>
                ...
                <h2>Insurance & Credentialing in Iowa</h2>
