...
@section('title', 'Telehealth in Charlottesville, VA | Redmond MMH')
@section('description', 'Virginia-licensed psychiatric care, family medicine, and weight loss treatment for Charlottesville and Albemarle County via secure telehealth.')
@section('keywords', 'Telehealth Charlottesville, Online Psychiatrist Charlottesville VA, Mental Health Albemarle County, Telehealth Virginia, Redmond MMH')
...
<script type="application/ld+json">
{
    ...
    "name": "Redmond Medical & Mental Health - Charlottesville Telehealth",
    "description": "Virginia-licensed online psychiatry, primary care, and weight loss services for Charlottesville and Albemarle County through secure telehealth.",
    "url": "https://redmondmmh.com/telehealth/virginia/charlottesville",
    "address": {
        "@type": "PostalAddress",
...
<script type="application/ld+json">
{
    ...
    "mainEntity": [
        {
            "@type": "Question",
            "name": "Is telehealth psychiatric care available to Charlottesville residents?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes. Tiffany Redmond, PA-C is licensed in Virginia and treats Charlottesville and Albemarle County patients for psychiatric medication management, primary care, and weight loss by secure video visit."
            }
        },
        {
            "@type": "Question",
            "name": "Is telehealth a good option even though Charlottesville already has a major academic medical center?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes. A large medical center can still mean a long wait for a new psychiatric appointment. Tiffany offers a faster path to an initial visit, and can coordinate with your existing providers or send referrals if in-person or specialty care is ever needed."
            }
        },
        {
            "@type": "Question",
            "name": "Will my insurance cover a Charlottesville telehealth visit?",
            "acceptedAnswer": {
                "@type": "Answer",
...
@section('content')
    <div class="hero charlottesville border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Charlottesville</h1>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Charlottesville", "item": "https://redmondmmh.com/telehealth/virginia/charlottesville" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Charlottesville, VA</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Even with a major university medical center nearby, psychiatric appointments in Charlottesville can book out for weeks for patients who aren't already established. Tiffany typically sees new patients same-day or next-day.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Local compounding pharmacy partnerships keep GLP-1 therapy more affordable and available to non-diabetic patients throughout the Charlottesville area.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Serving Charlottesville and Albemarle County</h2>
                    <p>Our Virginia-licensed telehealth services reach Charlottesville, Crozet, Pantops, Ivy, and the surrounding Albemarle County communities. Set along the Rivanna River in the shadow of the Blue Ridge Mountains, Charlottesville is home to the University of Virginia and sits near Thomas Jefferson's Monticello. Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages. We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients. We're in-network with the insurance plan listed below.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Charlottesville area pharmacy.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions &amp; Follow-up:</strong> Any necessary medications are sent to your preferred Charlottesville pharmacy immediately.</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container my-5">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Local FAQ</h2>
                    <h3>Is telehealth psychiatric care available to Charlottesville residents?</h3>
                    <p>Yes. Tiffany Redmond, PA-C is licensed in Virginia and treats Charlottesville and Albemarle County patients for psychiatric medication management, primary care, and weight loss by secure video visit.</p>
                    <h3>Is telehealth a good option even though Charlottesville already has a major academic medical center?</h3>
                    <p>Yes. A large medical center can still mean a long wait for a new psychiatric appointment. Tiffany offers a faster path to an initial visit, and can coordinate with your existing providers or send referrals if in-person or specialty care is ever needed.</p>
                    <h3>Will my insurance cover a Charlottesville telehealth visit?</h3>
