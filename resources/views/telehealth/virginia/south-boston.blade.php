...
@section('title', 'Telehealth in South Boston, VA | Redmond MMH')
@section('description', 'Skip the drive for care. Redmond MMH provides Virginia-licensed psychiatric, primary, and weight-loss care to South Boston and Halifax County.')
@section('keywords', 'Telehealth South Boston, Online Psychiatrist Halifax County VA, Mental Health Southside Virginia, Telehealth Virginia, Redmond MMH')
...
<script type="application/ld+json">
{
    ...
    "name": "Redmond Medical & Mental Health - South Boston Telehealth",
    "description": "Virginia-licensed online psychiatry, primary care, and weight loss services for South Boston and Halifax County through secure telehealth.",
    "url": "https://redmondmmh.com/telehealth/virginia/south-boston",
    "address": {
        "@type": "PostalAddress",
...
<script type="application/ld+json">
{
    ...
    "mainEntity": [
        {
            "@type": "Question",
            "name": "Is telehealth psychiatric care available to South Boston residents?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes. Tiffany Redmond, PA-C is licensed in Virginia and treats South Boston and Halifax County patients for psychiatric medication management, primary care, and weight loss by secure video visit."
            }
        },
        {
            "@type": "Question",
            "name": "How soon can I get an appointment in South Boston?",
            "acceptedAnswer": {
                "@type": "Answer",
...
@section('content')
    <div class="hero south-boston hero-va-5 border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in South Boston</h1>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">South Boston</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "South Boston", "item": "https://redmondmmh.com/telehealth/virginia/south-boston" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for South Boston, VA</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Finding an experienced psychiatric provider in Halifax County can mean a long waitlist or a long drive toward Danville or Richmond. Tiffany is easy to schedule with and often sees new patients the same day or next.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>We diagnose and manage the chronic conditions that shouldn't require a trip out of Halifax County &mdash; high blood pressure, diabetes, thyroid disease, PCOS, and hormone concerns including menopause and low testosterone.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Our individualized weight-management programs bring GLP-1 therapy &mdash; Semaglutide and Tirzepatide &mdash; to South Boston without a single trip to a big-city clinic. Coaching and nutrition guidance are built in.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Serving South Boston and Halifax County</h2>
                    <p>Our telehealth services reach South Boston and the surrounding communities of Halifax, Scottsburg, and Vernon Hill across Halifax County. Set along the Dan River near the North Carolina border in Virginia's historic tobacco belt, South Boston anchors a rural stretch of Southside Virginia where reaching a specialist has always meant a long drive. Redmond Medical and Mental Health brings psychiatric care, primary care, and weight-loss treatment to patients of every age &mdash; we see children as young as 4, as well as adolescents, adults, and seniors.</p>
                    <ul>
                        <li><strong>Virginia-Licensed Provider:</strong> Tiffany Redmond, PA-C holds an active Virginia license and treats South Boston residents directly by secure video.</li>
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions go electronically to the South Boston-area pharmacy you already use.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions &amp; Follow-up:</strong> Any medications are sent to your South Boston pharmacy right away.</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container my-5">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Local FAQ</h2>
                    <h3>Is telehealth psychiatric care available to South Boston residents?</h3>
                    <p>Yes. Tiffany Redmond, PA-C is licensed in Virginia and treats South Boston and Halifax County patients for psychiatric medication management, primary care, and weight loss by secure video visit.</p>
                    <h3>How soon can I get an appointment in South Boston?</h3>
