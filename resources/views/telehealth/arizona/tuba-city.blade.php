...
@section('title', 'Telehealth Tuba City | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and primary care for the western Navajo Nation—no drive to Flagstaff required.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Tuba City</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Specialty psychiatric providers are extremely scarce on the western Navajo Nation. Tiffany is licensed in Arizona and has over 30 years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—available by secure telehealth from your home.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, address acute concerns, and review lab results from your home in Tuba City, Moenkopi, or the surrounding chapters without the long drive to Flagstaff.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Tuba City, Moenkopi, Cameron, and the surrounding chapters of the western Navajo Nation. Whether you are searching for an "online psychiatrist near Tuba City" or "telehealth on the Navajo Nation," Redmond MMH brings consistent specialty care to a region long underserved by in-person providers.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Tuba City pharmacy.</li>
