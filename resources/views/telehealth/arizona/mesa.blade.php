...
<script type="application/ld+json">
{
  ...
  "name": "Redmond Medical & Mental Health - Mesa Telehealth",
  "description": "Arizona-licensed online psychiatry, primary care, and weight loss services for Mesa and the East Valley through secure telehealth.",
  "url": "https://redmondmmh.com/telehealth/arizona/mesa",
  "address": {
    "@type": "PostalAddress",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Mesa residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Mesa and Maricopa County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Mesa?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does insurance cover a Mesa telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to visit an office in Mesa?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    <div class="hero mesa border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Mesa</h1>
                    <p>Arizona-licensed Mental Health and medical care from the comfort of  home.  No long Phoenix commute required.</p>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Mesa", "item": "https://redmondmmh.com/telehealth/arizona/mesa" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Mesa, AZ</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in Mesa can be hard to find, especially those without a 3 month wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Serving Mesa and the East Valley</h2>
                    <p>Our Arizona-licensed telehealth services reach Mesa, Gilbert, Apache Junction, Tempe, Chandler, and the surrounding East Valley communities.  Home to Mesa Community College, Mesa is one of the largest cities in the East Valley, and Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Mesa area pharmacy.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions & Follow-up:</strong> Any necessary medications are sent to your preferred Mesa pharmacy immediately.</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <p>As a board-credentialed Physician Assistant with three decades of integrated medical and psychiatric experience, Tiffany Redmond brings that expertise directly to Mesa patients. <a class="rmmh_red" href="{{ route('about') }}">Read her full story on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Mesa Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Mesa residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Mesa and Maricopa County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Mesa?</span><br />
                    ...
                    <p><span class="question">Does insurance cover a Mesa telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to visit an office in Mesa?</span><br />
