...
@section('title', 'Telehealth Scottsdale | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and medical care—on your schedule, from your Scottsdale home.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Scottsdale</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Tiffany is licensed in Arizona and has over 30 years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—offering Scottsdale residents direct, personalized psychiatric care without the in-person office visit.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, address acute concerns, and review lab results from your Scottsdale home—efficient, private, and built around your calendar.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Scottsdale, Paradise Valley, Fountain Hills, Cave Creek, Carefree, and the surrounding Maricopa County communities. Whether you are searching for an "online psychiatrist in Scottsdale" or "concierge-style telehealth in Arizona," Redmond MMH provides integrated medical and mental health care that fits a busy schedule.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Scottsdale pharmacy.</li>
