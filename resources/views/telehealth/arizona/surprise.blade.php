...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Surprise residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Surprise and Maricopa County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Surprise?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does insurance cover a Surprise telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to visit an office in Surprise?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    <div class="hero surprise border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Surprise</h1>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Surprise</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Surprise", "item": "https://redmondmmh.com/telehealth/arizona/surprise" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Surprise, AZ</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in the Surprise area can be hard to find, especially those without a 3 month wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Serving Surprise and the Northwest Valley</h2>
                    <p>Our Arizona-licensed telehealth services reach Surprise, El Mirage, Sun City West, Sun City Grand, Waddell, and the surrounding Northwest Valley communities. As one of the larger cities in the Northwest Valley, Surprise is home to a mix of families and retirees, and Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Surprise area pharmacy.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions & Follow-up:</strong> Any necessary medications are sent to your preferred Surprise pharmacy immediately.</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <p>Tiffany Redmond, PA-C, has spent more than 30 years bridging physical and mental health care, and now brings that experience to Maricopa County via secure telehealth. <a class="rmmh_red" href="{{ route('about') }}">Read her full story on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Surprise Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Surprise residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Surprise and Maricopa County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Surprise?</span><br />
                    ...
                    <p><span class="question">Does insurance cover a Surprise telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to visit an office in Surprise?</span><br />
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ul>
                        ...
                        <li><a class="rmmh_red" href="{{ route('telehealth.arizona.buckeye') }}">Buckeye</a></li>
                        <li><a class="rmmh_red" href="{{ route('telehealth.arizona.phoenix') }}">Phoenix</a></li>
                        <li><a class="rmmh_red" href="{{ route('telehealth.arizona.scottsdale') }}">Scottsdale</a></li>
                    </ul>
                </div>
            </div>
        </div>
