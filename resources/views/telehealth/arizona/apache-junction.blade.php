...
<script type="application/ld+json">
{
  ...
  "url": "https://redmondmmh.com/telehealth/arizona/apache-junction",
  "address": {
    "@type": "PostalAddress",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Apache Junction residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Apache Junction and Pinal County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Apache Junction?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does insurance cover an Apache Junction telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to visit an office in Apache Junction?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed Mental Health and medical care for the Superstition foothills.  No big city commutes required.</p>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Apache Junction</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Apache Junction", "item": "https://redmondmmh.com/telehealth/arizona/apache-junction" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Apache Junction, AZ</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in Apache Junction can be hard to find, especially those without a long  wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Apache Junction, Gold Canyon, Mesa, Queen Creek, and the surrounding East Valley and Pinal County communities. Sitting at the base of the Superstition Mountains, Apache Junction residents no longer have to drive into the Valley for care, and Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Apache Junction pharmacy.</li>
    ...
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Apache Junction Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Apache Junction residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Apache Junction and Pinal County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Apache Junction?</span><br />
                    ...
                    <p><span class="question">Does insurance cover an Apache Junction telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to visit an office in Apache Junction?</span><br />
