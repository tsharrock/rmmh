...
@section('title', 'Telehealth Page AZ | Online Mental Health & Psychiatry | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and primary care for the Lake Powell region—no long drive to Flagstaff required.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Page</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Page is geographically isolated from Arizona's specialty providers. Tiffany is licensed in Arizona and has over 30 years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—reaching the Lake Powell region by secure video.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, handle acute concerns, and review lab results from your home in Page or Greenehaven without driving hours to a specialist.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Page, Greenehaven, LeChee, and the surrounding northern Coconino County and Glen Canyon communities. Whether you are searching for an "online psychiatrist near Page" or "telehealth at Lake Powell," Redmond MMH brings specialty care to one of Arizona's most remote population centers.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Page pharmacy.</li>
