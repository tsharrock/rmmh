...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Page residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Page and Coconino County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Page?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does insurance cover a Page telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to visit an office in Page?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    <div class="hero page border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Page</h1>
                    <p>Arizona-licensed Mental Health and medical care from the comfort of your house or houseboat.</p>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Page", "item": "https://redmondmmh.com/telehealth/arizona/page" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Page, AZ</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in Page can be hard to find, especially those without a long  wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Serving Page and the Lake Powell Region</h2>
                    <p>Our Arizona-licensed telehealth services reach Page, Greenehaven, LeChee, and the surrounding northern Coconino County and Glen Canyon communities near Lake Powell and Antelope Canyon. Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Page area pharmacy.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions & Follow-up:</strong> Any necessary medications are sent to your preferred Page pharmacy immediately.</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <p>Page patients work directly with Tiffany Redmond, PA-C, a provider with over 30 years of combined family medicine and psychiatric care experience. <a class="rmmh_red" href="{{ route('about') }}">See her full background on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Page Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Page residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Page and Coconino County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Page?</span><br />
                    ...
                    <p><span class="question">Does insurance cover a Page telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to visit an office in Page?</span><br />
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ul>
                        <li><a class="rmmh_red" href="{{ route('telehealth.arizona.tuba-city') }}">Tuba City</a></li>
