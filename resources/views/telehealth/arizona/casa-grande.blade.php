...
@section('title', 'Telehealth Casa Grande | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and primary care for Pinal County—no drive up to Phoenix or down to Tucson.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Casa Grande</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Casa Grande sits between Phoenix and Tucson but feels rural in terms of specialty access. Tiffany is licensed in Arizona and has over 30 years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—available without commuting to either metro.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, address acute concerns, and review lab results from your home in Casa Grande, Coolidge, or Eloy without taking a half-day off work for a clinic visit.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Casa Grande, Coolidge, Eloy, Arizona City, Florence, and the surrounding Pinal County communities. Whether you are searching for an "online psychiatrist near Casa Grande" or "telehealth in Pinal County," Redmond MMH brings specialty care directly to a region long underserved by in-person providers.</p>
                    <ul>
