...
@section('title', 'Telehealth San Tan Valley | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and primary care for one of the fastest-growing communities in Pinal County.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for San Tan Valley</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>San Tan Valley's young-family population has expanded faster than the local healthcare infrastructure. Tiffany is licensed in Arizona and brings 30+ years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—available without competing for limited Pinal County appointments.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, address acute concerns, and review lab results from your home in San Tan Valley, Johnson Ranch, or Magma Ranch—no drive into Mesa or Queen Creek for a routine visit.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach San Tan Valley, Queen Creek, Florence, Coolidge, and the surrounding Pinal County communities. Whether you are searching for an "online psychiatrist in San Tan Valley" or "telehealth in Pinal County," Redmond MMH provides integrated medical and mental health care that scales with the area's growth.</p>
                    <ul>
