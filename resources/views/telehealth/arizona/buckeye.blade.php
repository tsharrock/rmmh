...
@section('title', 'Telehealth Buckeye | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and primary care for one of the fastest-growing cities in the country.</p>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Buckeye's explosive growth has outpaced the availability of psychiatric specialists in the Far West Valley. Tiffany is licensed in Arizona and brings 30+ years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—giving Buckeye families specialty care without driving downtown.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, address acute concerns, and review lab results from your home in Buckeye, Verrado, or Sundance—no I-10 commute through the West Valley.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Buckeye, Verrado, Sundance, Tonopah, and the surrounding Far West Valley communities. Whether you are searching for an "online psychiatrist in Buckeye" or "telehealth in the Far West Valley," Redmond MMH provides integrated medical and mental health care that scales with how fast Buckeye is growing.</p>
                    <ul>
