...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Buckeye residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Buckeye and Maricopa County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Buckeye?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Many Maricopa County practices carry multi-week waitlists for psychiatry. We typically offer new telehealth patients an appointment within a few days, often the same day or next."
      }
    },
    {
      "@type": "Question",
      "name": "Does insurance cover a Buckeye telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to visit an office in Buckeye?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    <div class="hero buckeye border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Buckeye</h1>
                    <p>Skip the I-10 commute to Phoenix.  We are Arizona-licensed and specialize in Mental Health and medical care from the comfort of home.</p>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Buckeye</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Buckeye", "item": "https://redmondmmh.com/telehealth/arizona/buckeye" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Buckeye</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in Buckeye can be hard to find, especially those without a long wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
                        <p>Tiffany is licensed in Arizona and has over 30 years of experience in psychiatry treating ADD/ADHD, anxiety, depression, bipolar disorder, eating disorders, smoking cessation and addictions.  Get all of your mental health concerns addressed from the comfort of home and skip the I-10 commute to Phoenix!</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Serving Buckeye and the Far West Valley</h2>
                    <p>Our Arizona-licensed telehealth services reach Buckeye, Verrado, Sundance, Tonopah, and the surrounding Far West Valley communities. As one of the fastest-growing cities in the Far West Valley, Buckeye is spread across a lot of ground, and Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Buckeye pharmacy.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions & Follow-up:</strong> Any necessary medications are sent to your preferred Buckeye pharmacy immediately.</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <div class="credential-strip mb-3">
                        ...
                        <span class="credential-badge credential-badge-local">Serves Maricopa County</span>
                    </div>
                    <p>Tiffany Redmond, PA-C, is licensed in both Utah and Arizona and has spent over 30 years treating patients like those in Buckeye. <a class="rmmh_red" href="{{ route('about') }}">Learn more about her background on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Buckeye Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Buckeye residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Buckeye and Maricopa County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Buckeye?</span><br />
                    Many Maricopa County practices carry multi-week waitlists for psychiatry. We typically offer new telehealth patients an appointment within a few days, often the same day or next.</p>

                    <p><span class="question">Does insurance cover a Buckeye telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to visit an office in Buckeye?</span><br />
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ul>
                        <li><a class="rmmh_red" href="{{ route('telehealth.arizona.goodyear') }}">Goodyear</a></li>
                        <li><a class="rmmh_red" href="{{ route('telehealth.arizona.surprise') }}">Surprise</a></li>
                        <li><a class="rmmh_red" href="{{ route('telehealth.arizona.phoenix') }}">Phoenix</a></li>
