...
@section('title', 'Telehealth Sierra Vista | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and primary care for Cochise County, Fort Huachuca, and the surrounding military community.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Sierra Vista</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Sierra Vista has a large veteran and active-duty military population with significant unmet need for psychiatric care. Tiffany is licensed in Arizona and brings 30+ years of experience treating ADHD, anxiety, depression, bipolar disorders, PTSD-related symptoms, eating disorders, and addiction—including specific experience supporting service members and their families.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, address acute concerns, and review lab results from your home in Sierra Vista, Hereford, or anywhere across Cochise County—no drive to Tucson required.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Sierra Vista, Fort Huachuca, Hereford, Bisbee, Benson, and the surrounding Cochise County communities. Whether you are searching for an "online psychiatrist in Sierra Vista" or "telehealth for veterans in Arizona," Redmond MMH brings specialty care to a region with a strong military legacy and significant healthcare access gaps.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Sierra Vista pharmacy.</li>
