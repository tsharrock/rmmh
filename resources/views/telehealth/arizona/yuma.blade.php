...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Yuma residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Yuma and Yuma County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Yuma?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does insurance cover a Yuma telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to visit an office in Yuma?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    <div class="hero yuma border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Yuma</h1>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Yuma</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Yuma", "item": "https://redmondmmh.com/telehealth/arizona/yuma" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Yuma, AZ</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in Yuma can be hard to find, especially those without a long wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Serving Yuma and Yuma County</h2>
                    <p>Our Arizona-licensed telehealth services reach Yuma, Foothills, Somerton, San Luis, and the surrounding Yuma County communities, including students and staff at Arizona Western College. Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Yuma area pharmacy.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions & Follow-up:</strong> Any necessary medications are sent to your preferred Yuma pharmacy immediately.</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <div class="credential-strip mb-3">
                        ...
                        <span class="credential-badge credential-badge-local">Serves Yuma County</span>
                    </div>
                    <p>As a board-credentialed Physician Assistant with three decades of integrated medical and psychiatric experience, Tiffany Redmond brings that expertise directly to Yuma patients. <a class="rmmh_red" href="{{ route('about') }}">Read her full story on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Yuma Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Yuma residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Yuma and Yuma County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Yuma?</span><br />
                    ...
                    <p><span class="question">Does insurance cover a Yuma telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to visit an office in Yuma?</span><br />
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ul>
                        ...
                        <li><a class="rmmh_red" href="{{ route('telehealth.arizona.lake-havasu-city') }}">Lake Havasu City</a></li>
