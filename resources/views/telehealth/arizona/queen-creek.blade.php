...
@section('title', 'Telehealth Queen Creek | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and primary care for the fast-growing Southeast Valley.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Queen Creek</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Queen Creek's young-family population is growing faster than local psychiatric providers can absorb. Tiffany is licensed in Arizona and brings 30+ years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—giving Queen Creek families specialty mental health care without the long Southeast Valley wait.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, address acute concerns, and review lab results from your home in Queen Creek, Hastings Farms, or Cortina—no commute through Mesa for a routine visit.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Queen Creek, San Tan Valley, Gilbert, Apache Junction, and the surrounding Southeast Valley communities. Whether you are searching for an "online psychiatrist in Queen Creek" or "telehealth in the Southeast Valley," Redmond MMH provides integrated medical and mental health care that matches the area's pace of growth.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Queen Creek pharmacy.</li>
