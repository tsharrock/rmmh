...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Queen Creek residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Queen Creek and Maricopa/Pinal County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Queen Creek?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Many Maricopa and Pinal County practices carry multi-week waitlists for psychiatry. We typically offer new telehealth patients an appointment within a few days, often the same day or next."
      }
    },
    {
      "@type": "Question",
      "name": "Does insurance cover a Queen Creek telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to visit an office in Queen Creek?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    <div class="hero queen-creek border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Queen Creek</h1>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Queen Creek</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Queen Creek", "item": "https://redmondmmh.com/telehealth/arizona/queen-creek" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Queen Creek, AZ</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in Queen Creek can be hard to find, especially those without a long wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Serving Queen Creek and the Southeast Valley</h2>
                    <p>Our Arizona-licensed telehealth services reach Queen Creek, San Tan Valley, Gilbert, Apache Junction, and the surrounding Southeast Valley communities.  Sitting right on the Maricopa and Pinal County line, Queen Creek residents can access the same telehealth appointment no matter which side of the line they call home, and Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Queen Creek area  pharmacy.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions & Follow-up:</strong> Any necessary medications are sent to your preferred Queen Creek pharmacy immediately.</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <p>With more than three decades in mental health and primary care, Tiffany Redmond, PA-C, has helped patients across Pinal County manage everything from ADHD to chronic conditions. <a class="rmmh_red" href="{{ route('about') }}">Read her full story on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Queen Creek Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Queen Creek residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Queen Creek and Maricopa/Pinal County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Queen Creek?</span><br />
                    Many Maricopa and Pinal County practices carry multi-week waitlists for psychiatry. We typically offer new telehealth patients an appointment within a few days, often the same day or next.</p>

                    <p><span class="question">Does insurance cover a Queen Creek telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to visit an office in Queen Creek?</span><br />
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ul>
                        <li><a class="rmmh_red" href="{{ route('telehealth.arizona.san-tan-valley') }}">San Tan Valley</a></li>
