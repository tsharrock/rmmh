...
<script type="application/ld+json">
{
  ...
  "name": "Redmond Medical & Mental Health - Maricopa Telehealth",
  "description": "Arizona-licensed online psychiatry, primary care, and weight loss services for Maricopa, AZ and the surrounding Pinal County communities through secure telehealth.",
  "url": "https://redmondmmh.com/telehealth/arizona/maricopa",
  "address": {
    "@type": "PostalAddress",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Maricopa residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Maricopa and Pinal County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Maricopa?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does insurance cover a Maricopa telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to visit an office in Maricopa?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    <div class="hero maricopa border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Maricopa</h1>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Maricopa", "item": "https://redmondmmh.com/telehealth/arizona/maricopa" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Maricopa, AZ</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in Maricopa can be hard to find, especially those without a long wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Serving Maricopa and Pinal County</h2>
                    <p>Our Arizona-licensed telehealth services reach the City of Maricopa, Hidden Valley, Stanfield, Casa Grande, and the surrounding Pinal County communities.  Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Maricopa area pharmacy.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions & Follow-up:</strong> Any necessary medications are sent to your preferred Maricopa pharmacy immediately.</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <p>Tiffany Redmond, PA-C, is licensed in both Utah and Arizona and has spent over 30 years treating patients like those in Maricopa. <a class="rmmh_red" href="{{ route('about') }}">Learn more about her background on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Maricopa Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Maricopa residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Maricopa and Pinal County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Maricopa?</span><br />
                    ...
                    <p><span class="question">Does insurance cover a Maricopa telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to visit an office in Maricopa?</span><br />
