...
@section('title', 'Telehealth Tempe | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and medical care from the comfort of your Tempe home or dorm.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Tempe</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Tiffany is licensed in Arizona and has over 30 years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction. Tempe residents—including ASU students and faculty—get direct access to specialty psychiatric care without competing for limited campus appointments.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, handle acute concerns, and review lab results from your home in Tempe—no waiting room, no parking on Mill Avenue.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Tempe, Mesa, Chandler, Guadalupe, and the surrounding East Valley communities. Whether you are searching for an "online psychiatrist near ASU" or "telehealth in Tempe," Redmond MMH provides integrated medical and mental health care for students and working professionals alike.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Tempe pharmacy.</li>
