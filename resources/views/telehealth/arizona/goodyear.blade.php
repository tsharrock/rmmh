...
@section('title', 'Telehealth Goodyear | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and primary care for the fast-growing West Valley.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Goodyear</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Goodyear is among the fastest-growing cities in Arizona, but local healthcare infrastructure has not kept pace. Tiffany is licensed in Arizona and brings 30+ years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—giving Goodyear families specialty psychiatric care without the months-long wait.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, handle acute concerns, and review lab results from your home in Goodyear, Estrella, or Pebble Creek—no I-10 commute, no scarce parking.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Goodyear, Avondale, Litchfield Park, Tolleson, and the surrounding West Valley communities. Whether you are searching for an "online psychiatrist in Goodyear" or "telehealth in the West Valley," Redmond MMH provides integrated medical and mental health care that scales with the way the West Valley is growing.</p>
                    <ul>
