...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Prescott residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Prescott and Yavapai County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Prescott?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does insurance cover a Prescott telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to visit an office in Prescott?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    <div class="hero prescott border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Prescott</h1>
                    <p>Arizona-licensed Mental Health and medical care for Prescott and the Quad Cities from the comfort of home.</p>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Prescott</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Prescott", "item": "https://redmondmmh.com/telehealth/arizona/prescott" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Prescott, AZ</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in the Prescott area can be hard to find, especially those without a long wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Serving Prescott and the Quad Cities</h2>
                    <p>Our Arizona-licensed telehealth services reach Prescott, Prescott Valley, Chino Valley, Dewey-Humboldt, and the surrounding Yavapai County communities, including students and staff at Yavapai College.  Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Prescott area pharmacy.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions & Follow-up:</strong> Any necessary medications are sent to your preferred Prescott pharmacy immediately.</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <div class="credential-strip mb-3">
                        ...
                        <span class="credential-badge credential-badge-local">Serves Yavapai County</span>
                    </div>
                    <p>Tiffany Redmond, PA-C, brings over 30 years of combined mental health and primary care experience to every Prescott telehealth visit. <a class="rmmh_red" href="{{ route('about') }}">Read Tiffany's full story on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Prescott Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Prescott residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Arizona and sees Prescott and Yavapai County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Prescott?</span><br />
                    ...
                    <p><span class="question">Does insurance cover a Prescott telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to visit an office in Prescott?</span><br />
