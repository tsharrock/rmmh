...
@section('title', 'Telehealth Prescott | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and primary care for Prescott and the Quad Cities—skip the drive down to Phoenix.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Prescott</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Tiffany is licensed in Arizona and has over 30 years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction. Prescott's growing retiree population gets consistent access to specialty psychiatric care without the trip down to Phoenix.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, address acute concerns, and review lab results from your home in Prescott, Prescott Valley, or Chino Valley. Telehealth fits the way the Quad Cities lives.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Prescott, Prescott Valley, Chino Valley, Dewey-Humboldt, and the surrounding Yavapai County communities. Whether you are searching for an "online psychiatrist in Prescott" or "telehealth in central Arizona," Redmond MMH brings consistent specialty care to the high country.</p>
                    <ul>
