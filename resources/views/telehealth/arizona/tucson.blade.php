...
@section('title', 'Telehealth Tucson | Online Mental Health & Psychiatry in AZ | Redmond Medical & Mental Health')
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Arizona-licensed mental health and medical care from the comfort of your Tucson home.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Tucson</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Tucson is often underserved compared to Phoenix when it comes to specialty psychiatric care. Tiffany is licensed in Arizona and has over 30 years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—available without months on a wait list.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, handle acute concerns, and review lab results from your home in Tucson—no driving across the metro for a 15-minute visit.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our Arizona-licensed telehealth services reach Tucson, Marana, Oro Valley, Sahuarita, Vail, and the surrounding Pima County communities. Whether you are searching for an "online psychiatrist in Tucson" or "telehealth weight loss in southern Arizona," Redmond MMH provides integrated medical and mental health care without the wait.</p>
                    <ul>
