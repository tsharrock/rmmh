...
@section('content')
    <div class="hero orem border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Orem</h1>
                    <p>Expert Mental Health and Medical Care from the Comfort of Your Orem Home.</p>
    ...
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Orem</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Utah County wait lists for psychiatric care are notoriously long. Tiffany has over 30 years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—giving Orem residents direct access to specialty mental health care.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, handle acute concerns, and review lab results from your home in Orem—no fighting State Street traffic to a packed waiting room.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our telehealth services reach Orem, Provo, Lindon, Pleasant Grove, American Fork, and Vineyard. Whether you are searching for an "online psychiatrist in Orem" or "telehealth weight loss near BYU/UVU," Redmond MMH provides integrated medical and mental health care to North Utah County.</p>
                    <ul>
                        <li><strong>Local Pharmacy Partnerships:</strong> We work with Orem pharmacies to ensure your prescriptions are filled quickly.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions & Follow-up:</strong> Any necessary medications are sent to your preferred Orem pharmacy immediately.</li>
                    </ol>
                </div>
            </div>
        </div>
