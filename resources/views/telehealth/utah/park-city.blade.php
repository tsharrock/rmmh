...
@section('description', 'Concierge-style telehealth for Park City residents.')
...
<script type="application/ld+json">
{
  ...
  "url": "https://redmondmmh.com/telehealth/utah/park-city",
  "address": {
    "@type": "PostalAddress",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Park City residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Utah and sees Park City, Snyderville, and Kimball Junction patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Park City?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Many Summit County practices carry multi-week waitlists for psychiatry. We typically offer new telehealth patients an appointment within a few days, often the same day or next."
      }
    },
    {
      "@type": "Question",
      "name": "Does insurance cover a Park City telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to travel to an office for care in Park City?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Park City</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Park City", "item": "https://redmondmmh.com/telehealth/utah/park-city" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Park City, UT</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in Park City can be hard to find, especially those without a long wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our telehealth services reach Park City, Snyderville, Kimball Junction, Jeremy Ranch, Promontory, and the surrounding Summit and Wasatch County communities, home to the Park City Mountain Resort and Deer Valley ski resorts. Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Park City area pharmacy.</li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <p>Park City patients work directly with Tiffany Redmond, PA-C, a provider with over 30 years of combined family medicine and psychiatric care experience. <a class="rmmh_red" href="{{ route('about') }}">See her full background on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Park City Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Park City residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Utah and sees Park City, Snyderville, and Kimball Junction patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Park City?</span><br />
                    Many Summit County practices carry multi-week waitlists for psychiatry. We typically offer new telehealth patients an appointment within a few days, often the same day or next.</p>

                    <p><span class="question">Does insurance cover a Park City telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to travel to an office for care in Park City?</span><br />
