        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Specialty Mental Health and Medical Care from your Helper home—no canyon drive required.</p>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Helper residents have limited access to in-person psychiatric specialists. Tiffany has over 30 years of experience treating ADHD, anxiety, depression, bipolar disorders, eating disorders, and addiction—available by secure video from your home.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, address acute concerns, and review lab results from Helper, Spring Glen, or Kenilworth without the trip down to Price or over the canyon.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our telehealth services reach Helper, Spring Glen, Kenilworth, Sunnyside, and surrounding Carbon County communities. Whether you are searching for an "online psychiatrist near Helper" or "telehealth in Castle Country," Redmond MMH brings specialty care close to home.</p>
                    <ul>
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Helper or Price pharmacy.</li>
