...
@section('title', 'Telehealth in Tremonton, UT | Redmond MMH')
@section('description', 'No more long drives to Ogden or Logan for care. Redmond MMH offers psychiatric care, primary care, and weight loss via secure telehealth.')
