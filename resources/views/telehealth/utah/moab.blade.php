...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Moab residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Utah and sees Moab, Spanish Valley, and Castle Valley patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Moab?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Many Grand County practices carry multi-week waitlists for psychiatry. We typically offer new telehealth patients an appointment within a few days, often the same day or next."
      }
    },
    {
      "@type": "Question",
      "name": "Does insurance cover a Moab telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to travel to an office for care in Moab?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Moab</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Moab", "item": "https://redmondmmh.com/telehealth/utah/moab" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Moab, UT</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in Moab can be hard to find, especially those without a long wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our telehealth services reach all of Moab, Spanish Valley, Castle Valley, La Sal, and the surrounding Grand County communities near Arches National Park and Canyonlands National Park. Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
                        ...
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions are sent electronically to your preferred Moab area pharmacy.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <div class="credential-strip mb-3">
                        ...
                        <span class="credential-badge credential-badge-local">Serves Grand County</span>
                    </div>
                    <p>With more than three decades in mental health and primary care, Tiffany Redmond, PA-C, has helped patients across Grand County manage everything from ADHD to chronic conditions. <a class="rmmh_red" href="{{ route('about') }}">Read her full story on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Moab Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Moab residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Utah and sees Moab, Spanish Valley, and Castle Valley patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Moab?</span><br />
                    Many Grand County practices carry multi-week waitlists for psychiatry. We typically offer new telehealth patients an appointment within a few days, often the same day or next.</p>

                    <p><span class="question">Does insurance cover a Moab telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to travel to an office for care in Moab?</span><br />
