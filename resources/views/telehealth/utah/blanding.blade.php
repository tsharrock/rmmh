...
@section('title', 'Telehealth Blanding | Online Mental Health & Psychiatry | Redmond MMH')
@section('description', 'Specialty care for the Four Corners. Redmond MMH provides expert psychiatric care, family medicine, and weight loss treatment to Blanding and San Juan County via secure telehealth.')
@section('keywords', 'Telehealth Blanding, Online Psychiatry San Juan County, Mental Health Four Corners, Telehealth Utah, Redmond MMH')
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is telehealth psychiatry available to Blanding residents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tiffany Redmond, PA-C is licensed in Utah and sees Blanding and San Juan County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit."
      }
    },
    {
      "@type": "Question",
      "name": "How long is the wait for a new patient appointment in Blanding?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Does insurance cover a Blanding telehealth visit?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do I need to travel to an office for care in Blanding?",
      "acceptedAnswer": {
        "@type": "Answer",
...
@section('content')
    <div class="hero blanding border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Blanding</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Blanding", "item": "https://redmondmmh.com/telehealth/utah/blanding" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for San Juan County</h2>
                </div>
            </div>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our telehealth services reach Blanding, Monticello, Bluff, White Mesa, and the surrounding San Juan County communities, including residents living near Bears Ears National Monument. Redmond Medical and Mental Health brings virtual psychiatric services and specialty care to patients of all ages.  We treat children as young as 4 years old, as well as adolescents, adults and geriatric patients.  We also accept most major insurance plans.</p>
                    <ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <p>With more than three decades in mental health and primary care, Tiffany Redmond, PA-C, has helped patients across San Juan County manage everything from ADHD to chronic conditions. <a class="rmmh_red" href="{{ route('about') }}">Read her full story on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Blanding Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Blanding residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Utah and sees Blanding and San Juan County patients for psychiatric medication management, primary care, and weight loss consultations by secure video visit.</p>

                    <p><span class="question">How long is the wait for a new patient appointment in Blanding?</span><br />
                    ...
                    <p><span class="question">Does insurance cover a Blanding telehealth visit?</span><br />
                    ...
                    <p><span class="question">Do I need to travel to an office for care in Blanding?</span><br />
