...
@section('title', 'Telehealth in Blanding, UT | Redmond MMH')
@section('description', 'Specialty care for the Four Corners. Redmond MMH treats Blanding and San Juan County with psychiatric, primary, and weight-loss care via telehealth.')
