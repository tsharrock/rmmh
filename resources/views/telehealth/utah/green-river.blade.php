...
<script type="application/ld+json">
{
    ...
    "name": "Redmond Medical & Mental Health - Green River Telehealth",
    "description": "Online psychiatry, primary care, and weight-loss services for Green River and Emery County through secure telehealth.",
    "url": "https://redmondmmh.com/telehealth/utah/green-river",
    "address": {
        "@type": "PostalAddress",
...
<script type="application/ld+json">
{
    ...
    "mainEntity": [
        {
            "@type": "Question",
            "name": "Is telehealth psychiatry available to Green River residents?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes. Tiffany Redmond, PA-C is licensed in Utah and treats Green River and Emery County patients for psychiatric medication management, primary care, and weight loss by secure video visit."
            }
        },
        {
            "@type": "Question",
            "name": "How soon can I get an appointment in Green River?",
            "acceptedAnswer": {
                "@type": "Answer",
        ...
        {
            "@type": "Question",
            "name": "Will my insurance cover a Green River telehealth visit?",
            "acceptedAnswer": {
                "@type": "Answer",
...
@section('content')
    <div class="hero green-river border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Green River</h1>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Green River</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
{
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "position": 3,
            "name": "Green River",
            "item": "https://redmondmmh.com/telehealth/utah/green-river"
        }
    ]
}
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Green River, UT</h2>
                    <p>Distance shouldn't decide the quality of your health care. Redmond MMH connects Emery County residents to a Utah-licensed provider without the mileage.</p>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Residents of Green River shouldn't have to choose between a months-long wait and a two-way drive to Price or Moab, each roughly an hour away for mental health care. Tiffany keeps scheduling simple and can typically see you the same day or next.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Managing a chronic condition in a rural area often means repeat trips to Price or Moab, each roughly an hour away. We handle high blood pressure, diabetes, thyroid disorders, PCOS, and hormone balancing entirely online.</p>
                        <p>We also treat acute concerns &mdash; infections, injuries, skin problems &mdash; and coordinate any labs or specialist referrals through providers close to Green River.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Local compounding pharmacies make the medications affordable and available to Green River patients who never thought GLP-1 therapy was an option.</p>
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p>Our telehealth services reach Green River and the surrounding communities of Emery County &mdash; Elgin, and Crescent Junction. Set in one of Utah's most remote stretches of I-70, near the Green River, the Book Cliffs, and world-famous melons, this is exactly the kind of place where reaching a specialist has always meant a long drive. Redmond Medical and Mental Health brings psychiatric care, primary care, and weight-loss treatment to patients of every age &mdash; we see children as young as 4, adolescents, adults, and seniors &mdash; and accept most major insurance plans.</p>
                    <ul>
                        <li><strong>Utah-Licensed Provider:</strong> Tiffany Redmond, PA-C holds an active Utah medical license and treats Green River residents directly by secure video.</li>
                        <li><strong>Local Pharmacy Partnerships:</strong> Prescriptions go electronically to the Green River-area pharmacy you already use.</li>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <ol>
                        ...
                        <li><strong>Prescriptions &amp; Follow-up:</strong> Any medications are sent to your Green River pharmacy right away.</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 ">
                    ...
                    <p>Tiffany Redmond, PA-C brings more than 30 years of combined mental health and primary care experience to every Green River telehealth visit. <a class="rmmh_red" href="{{ route('about') }}">Read Tiffany's full story on our About page</a>.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="faq" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Green River Telehealth FAQs</h2>
                    <p><span class="question">Is telehealth psychiatry available to Green River residents?</span><br />
                    Yes. Tiffany Redmond, PA-C is licensed in Utah and treats Green River and Emery County patients for psychiatric medication management, primary care, and weight loss by secure video visit.</p>

                    <p><span class="question">How soon can I get an appointment in Green River?</span><br />
                    ...
                    <p><span class="question">Will my insurance cover a Green River telehealth visit?</span><br />
