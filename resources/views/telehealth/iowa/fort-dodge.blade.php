...
@section('title', 'Telehealth in Fort Dodge, IA | Redmond MMH')
...
@section('content')
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Fort Dodge</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Fort Dodge", "item": "https://redmondmmh.com/telehealth/iowa/fort-dodge" }
      ]
    }
    </script>
