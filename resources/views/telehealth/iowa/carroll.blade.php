...
<script type="application/ld+json">
{
    ...
    "url": "https://www.redmondmmh.com/telehealth/iowa/carroll",
    "address": {
        "@type": "PostalAddress",
...
@section('content')
    <div class="hero carroll hero-ia-{{ random_int(1, 5) }} border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Experienced psychiatric providers in Carroll can be hard to find, especially those without a long wait.  Tiffany is easy to schedule with and can typically see patients the same day or next.  We take the headache out of scheduling and make the process simple.</p>
