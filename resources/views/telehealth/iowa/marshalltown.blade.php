...
@section('title', 'Telehealth Marshalltown | Online Mental Health &amp; Psychiatry in IA | Redmond Medical &amp; Mental Health')
...
<script type="application/ld+json">
{
    ...
    "url": "https://www.redmondmmh.com/telehealth/iowa/marshalltown",
    "address": {
        "@type": "PostalAddress",
...
@section('content')
    <div class="hero marshalltown border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
