...
@section('title', 'Telehealth in Waterloo, IA | Redmond MMH')
...
@section('content')
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Waterloo", "item": "https://redmondmmh.com/telehealth/iowa/waterloo" }
      ]
    }
    </script>
