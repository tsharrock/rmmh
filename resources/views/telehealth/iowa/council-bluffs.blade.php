...
@section('title', 'Telehealth in Council Bluffs, IA | Redmond MMH')
...
@section('content')
    <div class="hero council-bluffs hero-ia-4 border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Council Bluffs</h1>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Council Bluffs</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Council Bluffs", "item": "https://redmondmmh.com/telehealth/iowa/council-bluffs" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Council Bluffs, IA</h2>
                </div>
            </div>
