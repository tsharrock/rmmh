...
@section('title', 'Telehealth Burlington | Online Mental Health & Psychiatry in IA | Redmond MMH')
...
<script type="application/ld+json">
{
    ...
    "url": "https://www.redmondmmh.com/telehealth/iowa/burlington",
    "address": {
        "@type": "PostalAddress",
...
@section('content')
    <div class="hero burlington hero-ia-{{ random_int(1, 5) }} border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
