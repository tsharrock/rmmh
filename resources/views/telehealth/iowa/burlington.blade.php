...
@section('title', 'Telehealth in Burlington, IA | Redmond MMH')
@section('description', 'Iowa-licensed psychiatric care, family medicine, and weight loss treatment for Burlington and the Great River region via secure telehealth.')
@section('keywords', 'Telehealth Burlington, Online Psychiatrist Burlington IA, Mental Health Des Moines County, Telehealth Iowa, Redmond MMH')
...
<script type="application/ld+json">
{
    ...
    "name": "Redmond Medical & Mental Health - Burlington Telehealth",
    "description": "Iowa-licensed online psychiatry, primary care, and weight loss services for Burlington and the Great River region through secure telehealth.",
    "url": "https://redmondmmh.com/telehealth/iowa/burlington",
    "address": {
        "@type": "PostalAddress",
...
@section('content')
    <div class="hero burlington hero-ia-1 border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Burlington</h1>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Burlington</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Burlington", "item": "https://redmondmmh.com/telehealth/iowa/burlington" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Burlington, IA</h2>
                </div>
            </div>
