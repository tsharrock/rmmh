...
@section('title', 'Telehealth in Dubuque, IA | Redmond MMH')
...
@section('content')
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Dubuque</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Dubuque", "item": "https://redmondmmh.com/telehealth/iowa/dubuque" }
      ]
    }
    </script>
