...
@section('title', 'Telehealth in Miles City, MT | Redmond MMH')
...
@section('content')
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Miles City</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Miles City", "item": "https://redmondmmh.com/telehealth/montana/miles-city" }
      ]
    }
    </script>
