...
@section('title', 'Telehealth in Havre, MT | Redmond MMH')
@section('description', 'Montana-licensed psychiatric care, family medicine, and weight loss treatment for Havre and the Hi-Line via secure telehealth.')
@section('keywords', 'Telehealth Havre, Online Psychiatrist Havre MT, Mental Health Hill County, Telehealth Montana, Redmond MMH')
...
@section('content')
    <div class="hero havre hero-mt-1 border-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1>Telehealth in Havre</h1>
    ...
    <div class="container mt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Havre</li>
            </ol>
        </nav>
    </div>
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Havre", "item": "https://redmondmmh.com/telehealth/montana/havre" }
      ]
    }
    </script>
    <section id="page-content">
        <div class="container py-lg-5">
            <div class="row">
                <div class="col">
                    <h2>Accessible Care for Havre, MT</h2>
                </div>
            </div>
