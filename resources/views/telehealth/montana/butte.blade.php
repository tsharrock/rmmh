...
@section('title', 'Telehealth in Butte, MT | Redmond MMH')
...
@section('content')
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Butte", "item": "https://redmondmmh.com/telehealth/montana/butte" }
      ]
    }
    </script>
