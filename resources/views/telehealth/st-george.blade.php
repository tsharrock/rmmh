...
@section('title', 'Telehealth St. George | Medical Weight Loss & Psychiatry | Redmond Medical & Mental Health')
...
@section('keywords', '<meta name="keywords" content="Telehealth St. George, Medical Weight Loss St. George, Online Psychiatry Utah, Semaglutide St. George, Mental Health Southern Utah">')
        ...
        <div class="container py-lg-5">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-3 mb-2 mb-lg-0">
                    <div class="info-card">
                        <h3 class="text-center">Mental Health & Psychiatry</h3>
                        <p>We provide comprehensive online medication management and psychiatric care for Anxiety, Depression, PTSD, and ADHD. Get expert help from Tiffany Redmond, PA-C, regardless of your location.</p>
                ...
                <div class="col-md-6 col-lg-3 mb-2 mb-lg-0">
                    <div class="info-card">
                        ...
                        <p>Manage chronic conditions, discuss lab results, or seek primary care advice through our HIPAA-compliant video visits. Quality family medicine is now available wherever you are in Southern Utah.</p>
