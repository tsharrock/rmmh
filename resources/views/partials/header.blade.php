    <nav class="navbar navbar-expand-lg border-bottom site-navbar" aria-label="navbar">
        <div class="container">
            <div class="navbar-top-row">
                <a class="navbar-brand" href="{{ route('home') }}"><img src="/img/wide-logo.svg"
                        alt="Redmond Medical and Mental Health" class="site-logo" /></a>

                <div class="nav-cta d-none d-lg-flex">
                    <div class="nav-phone text-black">Phone or Text: <a class="text-black" href="tel:4359381440">(435)
                            938-1440</a></div>
                    <a href="https://nextpatient.co/p/redmondmedical/schedule" class="btn rmmh_button_primary"
            ...
            <div class="collapse navbar-collapse" id="navbarsExample07">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('psychiatric-care') }}">Psychiatric Care</a>
                            </li>
                            ...
                            <li><a class="dropdown-item" href="{{ route('iv-fluids') }}">IV Nutrition & Injectables</a>
                            </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"
                            aria-expanded="false">Accepted Insurance Plans</a>
                        <ul class="dropdown-menu">
                ...
                <div class="nav-cta nav-cta-mobile d-lg-none">
                    <div class="nav-phone text-black">Phone or Text: <a class="text-black" href="tel:4359381440">(435)
                            938-1440</a></div>
                    <a href="https://nextpatient.co/p/redmondmedical/schedule" class="appt appt-sm"
                        target="_blank">Schedule an Appointment</a>
                </div>
            </div>
        </div>
